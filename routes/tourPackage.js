...
router.post("/", auth, checkRole(["admin"]), upload.array('images[]'), tourPackageController.createTourPackage)
router.put("/:id", auth, checkRole(["admin"]), upload.array('images[]'), tourPackageController.updateTourPackage)
